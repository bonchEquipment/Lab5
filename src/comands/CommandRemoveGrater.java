...
public class CommandRemoveGrater implements CommandWithArgument {
    ...
    public String execute() {
        if (isArgumentANumber(userEnteredId)) {
            if (collectionEditor.removeGraterThan(id)) {
                return "all elements with id greater that " + id + " was successfully deleted\n";
            } else {
                return "there is no elements with id greater that  " + id;
            }
        } else {
